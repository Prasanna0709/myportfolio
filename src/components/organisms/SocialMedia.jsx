...
const SocialMedia = () => {
  return (
    <div className='sm:h-[320px] sm:w-[100px] flex flex-col items-center absolute left-[25px] sm:left-[30px] md:left-[40px] lg:left-[80px] xl:left-[120px] bottom-[0px] z-[60]'>
